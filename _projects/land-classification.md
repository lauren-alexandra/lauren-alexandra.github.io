...
The spectral signatures plot depicts observed clusters in the Lower Putah Creek watershed. With bands ranging across varying wavelengths, cluster inertia was calculated to determine the optimal number of clusters. Five clusters were selected to best represent the scope of the spectral bands (aerosol, red, green, blue, and infrared). The watershed is mostly flat and surrounded by agriculture, with the exception of the Yolo Bypass Wildlife Area (YBWA). The area is composed of an assortment of habitats such as seasonal and permanent wetlands, vernal pools, and riparian forest. This variation is not shown in the clustering however, likely due to managed seasonal flooding for migratory waterfowl. 

YBWA is managed by the California Department of Fish and Wildlife as part of a larger endeavor to steward habitats in the Yolo Basin, located in the northern area of the Sacramento-San Joaquin River Delta. The [Yolo Bypass](https://www.ppic.org/blog/the-yolo-bypass-its-a-floodplain-its-farmland-its-an-ecosystem) maintains 60,000 acres for the Sacramento River during high flood events which drains back into the river and the Delta. Beyond flood management, the bypass supplies key ecological benefits to fish, and the lower Putah Creek plays a role in this function. During the recent [rehabilitation of the creek](https://californiawaterblog.com/2023/07/08/putah-creeks-rebirth-a-model-for-reconciling-other-degraded-streams), native fishes recovered and reversed a dominance of nonnative species in the creek and their growing presence in the bypass. Yolo Bypass provides nursery area for young fish in the north of the Delta as well as good habitat for [migrating salmon](https://viewperformance.deltacouncil.ca.gov/pm/yolo-bypass-inundation). Recognizing the multi-purpose benefits delivered by the bypass in addition to the pressing mandate to build resiliency under climate change, Congress authorized a [comprehensive study](https://www.spk.usace.army.mil/Missions/Civil-Works/Yolo-Bypass) of the Yolo Bypass (2020) to be conducted by the US Army Corps of Engineers (2023-2029). The study will engage federal, state, and local stakeholders to create recommendations for bypass project purposes and address multiple public needs in the future of the state's primary floodplain.
